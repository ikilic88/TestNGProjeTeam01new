...
public class Test_TC05 {
    ...
    public void testTC05 ()throws Exception {
        ...
        //Vendor Phone kismina harf girer
        pearly12.PhoneNumber.sendKeys("a", Keys.ENTER);

        //Vendor SAVE ADDRESS butonuna tiklar
        pearly12.saveButton.click();

        //Vendor Phone is a required field. yazisini gorur ve harf girilemedigini dogrular
    }
}
