...
public class Test_TC09 {
    ...
    public void testTC09()throws Exception {
        ...
        //Vendor Phone kismina 11 haneden fazla rakam girer
        pearly12.PhoneNumber.sendKeys("1234567891234", Keys.ENTER);

        //Vendor SAVE ADDRESS butonuna tiklar
        pearly12.saveButton.click();

        //Vendor Address changed successfully. yazisini gorur ve phone un 11 haneden fazla olarak girildigini dogrular
