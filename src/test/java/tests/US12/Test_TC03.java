...
public class Test_TC03 {
    ...
    public void testTC03()throws Exception {
        ...
        //Vendor Postcode kismina harf girer
        pearly12.postCode.sendKeys("a", Keys.ENTER);
        ...
        //Vendor Address changed successfully. yazisini gorur ve postcode un harf girildigini dogrular
