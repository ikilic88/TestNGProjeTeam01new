...
public class Test_TC06 {
    ...
    public void testTC06()throws Exception {
        ...
        //Vendor Phone kismina ozel karakter girer
        pearly12.PhoneNumber.sendKeys("@", Keys.ENTER);

        //Vendor SAVE ADDRESS butonuna tiklar
        pearly12.saveButton.click();

        //Vendor Phone is a required field. yazisini gorur ve ozel girilemedigini dogrular
