...
public class Test_TC02{
    ...
    public void testTC02() throws Exception{
        ...
        //Vendor Town / City kismina rakam girer
        pearly12.city.sendKeys("12345", Keys.ENTER);
        ...
        //Vendor Address changed successfully. yazisini gorur ve Town / City kismina rakam girilebildigini dogrular
