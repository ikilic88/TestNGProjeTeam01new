...
public class Test_TC08 {
    ...
    public void testTC08()throws Exception {
        ...
        //Vendor Phone kismina 11 haneden az rakam girer
        pearly12.PhoneNumber.sendKeys("12345", Keys.ENTER);

        //Vendor SAVE ADDRESS butonuna tiklar
        pearly12.saveButton.click();

        //Vendor Address changed successfully. yazisini gorur ve phone un 11 haneden az olarak girildigini dogrular
